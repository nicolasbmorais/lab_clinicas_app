...
import 'package:lab_clinicas_self_service/src/services/login_service_impl.dart';
...
class LoginRouter extends FlutterGetItModulePageRouter {
  ...
  List<Bind<Object>> get bindings => [
        Bind.lazySingleton<UserLoginServiceInterface>((i) => UserLoginServiceImpl(userRepository: i())),
